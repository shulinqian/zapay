...
use thinkweb\zapay\ChargeContext;
...
if ($type === Config::ALI_CHANNEL_APP) {
    ...
    $url = \thinkweb\zapay\Utils\DataParser::toQRimg($ret);// 内部会用到google 生成二维码的api  可能有些同学反应很慢
    echo "<img alt='支付宝扫码支付' src='{$url}' style='width:150px;height:150px;'/>";exit;
} elseif ($type === Config::WX_CHANNEL_QR) {
    $url = \thinkweb\zapay\Utils\DataParser::toQRimg($ret);
