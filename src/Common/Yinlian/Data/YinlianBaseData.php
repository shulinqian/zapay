...
namespace thinkweb\zapay\Common\Yinlian\Data;
 ...
 */
abstract class YinlianBaseData extends BaseData
{
    ...
    public function setSign()
    {
        ...
        $this->retData = $this->makeSign($this->retData);
    }

    protected function makeSign($signStr){
        AcpService::sign($signStr);
        return $signStr;
    }
