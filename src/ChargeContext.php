...
use thinkweb\zapay\Charge\Ali\AliAppCharge;
use thinkweb\zapay\Charge\Ali\AliWapCharge;
use thinkweb\zapay\Charge\Ali\AliWebCharge;
use thinkweb\zapay\Charge\Ali\AliQrCharge;
use thinkweb\zapay\Charge\Weixin\WxAppCharge;
use thinkweb\zapay\Charge\Weixin\WxPubCharge;
use thinkweb\zapay\Charge\Weixin\WxQrCharge;
use thinkweb\zapay\Charge\Yinlian\YinlianB2bCharge;
        ...
        try {
            switch ($channel) {
                ...
                case Config::WX_CHANNEL_APP:
                    ...
                    break;
                case Config::YINLIAN_B2B:
                    $this->payWay = new YinlianB2bCharge($config);
                    break;
                default :
                    throw new PayException('当前仅支持：支付宝、银联 与 微信');
            }
